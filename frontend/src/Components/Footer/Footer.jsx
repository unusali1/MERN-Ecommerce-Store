    ...
    <div className="Footer flex space__around pz__15" style={{"borderTop":".3px solid rgba(21,21,21,0.5)"}}>
      ...
      <div className="footer1st">
        ...
        <div className="location flex py__10">
          ...
          <h6>Rampura, Dhaka, Bangladesh</h6>
        </div>
        ...
        <div className="app">
            ...
            <Link to="/creator"><img src="http://wp.alithemes.com/html/nest/demo/assets/imgs/theme/app-store.jpg" style={{"width":"150px","margin":"10px"}} alt="not found" /></Link>
            <Link to="/creator"><img src="http://wp.alithemes.com/html/nest/demo/assets/imgs/theme/google-play.jpg" style={{"width":"150px","margin":"10px"}} alt="not found" /></Link>
            </div>
        </div>
      </div>
      {/* Footer 2nd part */}
